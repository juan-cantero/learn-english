  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-full bg-accent-primary text-sm font-semibold text-white transition-transform hover:scale-105"
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-56 rounded-lg border border-border bg-bg-card py-1 shadow-xl">
          ...
          <div className="border-t border-border py-1">
            <button
              ...
              className="block w-full px-4 py-2 text-left text-sm text-red-400 transition-colors hover:bg-bg-elevated"
            >
              Sign Out
            </button>
          </div>
