...
const navItems: NavItem[] = [
  { to: '/', label: 'Browse', icon: <HomeIcon />, matchPattern: /^\/(shows\/|$)/ },
  { to: '/phonemes', label: 'Phonemes', icon: <PhonemeIcon /> },
...
export function BottomNavigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-edge-default bg-bg-card/95 backdrop-blur-md pb-safe md:hidden">
