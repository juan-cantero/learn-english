...
export function ShowCard({ show }: ShowCardProps) {
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl bg-bg-card shadow-sm transition-all hover:bg-bg-card-hover hover:ring-1 hover:ring-brand/50 hover:scale-[1.01] hover:shadow-lg hover:shadow-brand/10 active:scale-[0.98] active:shadow-sm focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 focus:ring-offset-bg-primary"
    >
